      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Led by industry veterans with decades of combined experience in security, technology, and business management.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-64 bg-gray-200">
                <Image 
                  src="https://images.unsplash.com/photo-1507003211169-0fc1a8c810a4" 
                  alt="CEO Portrait" 
                  width={400} 
                  height={400} 
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900">Wei Zhang</h3>
                <p className="text-gray-600 mb-4">Chief Executive Officer</p>
                <p className="text-gray-700 text-sm">
                  With over 25 years of experience in the security industry, Wei has led Uniview through exceptional growth and innovation.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-64 bg-gray-200">
                <Image 
                  src="https://images.unsplash.com/photo-1573496359394-025c7bea9c16" 
                  alt="CTO Portrait" 
                  width={400} 
                  height={400} 
                  className="w-full h-full object-cover"
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 text-sm">
                  An MIT graduate with a background in computer vision, Sophia drives our technological innovation and R&D initiatives.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900">Michael Park</h3>
                <p className="text-gray-600 mb-4">Chief Operations Officer</p>
                <p className="text-gray-700 text-sm">
                  Michael oversees global operations, ensuring excellence in manufacturing, supply chain, and service delivery.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">Chief Sales Officer</p>
                <p className="text-gray-700 text-sm">
                  With extensive experience in international business, Sarah leads our global sales strategy and market expansion.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-700 mb-6">
              Our leadership team is supported by over 3,000 dedicated employees worldwide, working together to deliver exceptional security solutions and customer experiences.
            </p>
          </div>
        </div>
      </section>
